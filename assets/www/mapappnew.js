...
//				mapdata,mapdata);
		...
		var input = document.getElementById('uSourceTextField');	
                 ...
                 { 'panel' : document.getElementById('dir_panel')},
                       function (result, status) {
                           if (status === 'OK') {
                               ...
                               alert(getpresentLoc());
                               $("#uSourceTextField").val(""+getpresentLoc());
...
function getLocation(type){
	...
	var onSuccess = function(position) {
	   console.log('Latitude: '          +      position.coords.latitude     + '\n' +
	    ...
	    //mapdata=[];
	    mapdata={ destination: new google.maps.LatLng(glat, position.coords.longitude ) };
	};
